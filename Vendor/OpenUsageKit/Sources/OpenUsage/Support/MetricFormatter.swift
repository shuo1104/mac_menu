    ...
    static func totalSpendRingCenter(_ value: Double, metric: TotalSpendMetric) -> TotalSpendRingCenter {
        ...
        case .cost:
            ...
            return TotalSpendRingCenter(
                primary: number(value, kind: .dollars, style: .tray),
                unit: L10n.string("dollars")
            )
        case .tokens:
