...
enum AboutPanel {
    ...
    private static var credits: NSAttributedString {
        ...
        credits.append(NSAttributedString(string: L10n.string("Created by "), attributes: base))
        credits.append(link("Robin Ebers", "https://itsbyrob.in/x", base: base))
        credits.append(NSAttributedString(string: "\n" + L10n.string("Maintained also by "), attributes: base))
        ...
        credits.append(NSAttributedString(string: "\n\n" + L10n.string("Open source on "), attributes: base))
